...
Node.js로 여러 종목의 일봉 데이터를 분석해, 16:9 차트 좌표계에서 강하게 우하향하는 종목을 필터링하고 SVG 차트 HTML을 생성하는 예제입니다.
...
생성된 파일을 브라우저에서 열면 `demoResults` 상위 5개 종목의 SVG 차트를 확인할 수 있습니다.
...
| `index.js` | 실행 진입점, SVG 차트 HTML 생성 및 저장 |
| `chart.html` | 생성된 차트 확인용 정적 HTML |
